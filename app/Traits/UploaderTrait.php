...
trait UploaderTrait{
    ...
    public function uploadFile($file, $folder = "")
    {
     ...
     public function uploadByInterventionImage($imageFile, $width, $folder) {

        $manager = ImageManager::gd(); // or ::imagick() if preferred
        ...
        $fileName = $this->getUniqueId() . '.' . $imageFile->getClientOriginalExtension();
