...
class SquareController extends Controller
{
    ...
    //      $accessToken = 'EAAAl0sXTIIXFzMHnhEjumDX7YRO5wU2uBHhaXj0wru--sNoGUgD1iLdEY2hYnnh';
    ...
    //         echo "Currency     : " . $location['currency'] . "\n";
    //         echo "Capabilities : " . implode(', ', $location['capabilities'] ?? []) . "\n";
    //     }
    //     die;
    // }
}
