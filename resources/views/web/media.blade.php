    ...
    <section class="cdc-media-wrapper ">
        <div class="container">
            <div class="row">
                ...
                @if (isset($cdcs_media) && count($cdcs_media) == 0)
                ...
                <div class="col-12 col-md-12 mb-2 mb-md-4">
                    <div class="common-title">
                        ...
                        <h3>Our CDC Media Beginning With The Letter {{ $letter }} </h3>
                ...
                @for ($i = 97; $i <= 122; $i++)
                    ...
                    <div class="drug-name-list">
                        <h4>Media Beginning With </h4>
                        <h5>The Letter {{ strtoupper(chr($i)) }} </h5>
                        <a class="arrow-btn" href="{{ route('media-letter', chr($i))}}"><i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                @endfor
                @endif

                @if (isset($cdcs) && count($cdcs) > 0)
                    @foreach ($cdcs as $cdc)
                    ...
                    <div class="col-12 mt-4">
                        {{ $cdcs->links('pagination::bootstrap-5') }}
                    </div>
                @elseif (isset($cdcs) && count($cdcs) == 0)
